 ...
 *
 * Taken from Drupal core:
 * http://api.drupal.org/api/drupal/includes!common.inc/function/valid_url/7
 */
if (!function_exists('laguna_is_website')):
function laguna_is_website($string, $soft = FALSE) {
  if ($soft) {
